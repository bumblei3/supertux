...
// Minimal logging stubs so ColorspaceOklabTest can link util/colorspace_oklab.cpp
// and video/color.cpp without dragging in the engine console/Squirrel layer.
// g_log_level defaults to LOG_NONE, so log macros short-circuit; the linker
